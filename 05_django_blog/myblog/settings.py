...
SECRET_KEY = 'django-insecure-3)6)u&)0=z)n!8d=g_jm)ns89!ys&-z)l((2pgi3x^kct@-e_('
...
INSTALLED_APPS = [
    'blog.apps.BlogConfig', # La nostra app prima, per priorità su template e traduzioni
...
# Dove reindirizzare l'utente dopo il login
